    ...
    <div class="container login">
        <div class="row lg-4">
            ...
            <div class="info-container d-flex flex-column align-items-center justify-content-center">
                ...
                <a href="<?= base_url('user/home') ?>" class="info-item d-flex align-items-center justify-content-center">
                    Submit
                </a>
            </div>
            <!-- </div> -->
        ...
        Belum punya akun ? <a href="<?= base_url('user/register') ?>">register</a> disini
    </div>
    <br />
    <br />
    <br />
